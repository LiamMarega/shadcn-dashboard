...
export const Icons = {
  ...
  logoBlue: ({ ...props }: LucideProps) => (
    <svg
      id="Capa_2"
      data-name="Capa 2"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 725.65 782.25"
      {...props}
    >
      <defs>
        <linearGradient
          id="Degradado_sin_nombre_35"
          data-name="Degradado sin nombre 35"
          x1="61.82"
          y1="659.84"
          x2="61.82"
          y2="773"
      ...
      <g id="Capa_4" data-name="Capa 4">
        <g>
          <path
            className="cls-5"
            d="M63.86,755.96c-21.81,0-32.9-13.24-32.9-39.33s11.29-38.75,32.51-38.75c16.94,0,26.09,7.59,28.82,23.56h31.15c-3.31-32.52-23.75-49.65-59.38-49.65-40.5,0-64.06,23.75-64.06,65.03s22.98,65.42,64.06,65.42c36.41,0,56.85-17.72,59.58-51.6h-30.96c-2.34,17.13-11.49,25.31-28.82,25.31Z"
          />
          <rect
            className="cls-4"
            x="141.93"
          ...
          <path
            className="cls-1"
            d="M208.9,630.18c-10.12,0-16.74,6.04-16.74,15.38s6.62,15.38,16.74,15.38,17.33-6.23,17.33-15.38-6.81-15.38-17.33-15.38Z"
          />
          <rect
            className="cls-2"
            x="194.89"
          ...
          <path
            className="cls-8"
            d="M295.93,671.27c-34.66,0-54.13,19.66-54.13,55.3s19.66,55.69,55.3,55.69c27.84,0,44.78-12.46,49.65-36.41h-28.04c-2.73,8.37-9.74,12.85-21.22,12.85-15.77,0-24.34-8.18-26.09-24.73h76.13c.39-4.09.78-9.74.58-16.55-1.17-29.2-19.86-46.14-52.18-46.14ZM271.79,716.63c2.34-14.6,10.71-22,24.53-22,14.8,0,23.75,8.37,24.34,22h-48.87Z"
          />
          <path
            className="cls-10"
            d="M427.93,671.27c-15.58,0-26.09,5.45-34.85,14.99l-4.48-13.05h-22.78v107.09h28.82v-70.48c6.43-8.76,14.6-13.63,23.17-13.63,13.83,0,20.83,7.79,20.83,23.17v60.94h28.82v-67.76c0-24.34-15.77-41.28-39.53-41.28Z"
          />
          <path
            className="cls-12"
            d="M526.64,739.61v-45.56h29.4v-20.83h-29.4v-30.18l-28.82,6.23v23.95h-18.69v20.83h18.69v52.76c0,23.36,13.44,35.43,39.53,35.43,6.04,0,16.35-.78,19.47-1.36v-24.92c-3.5.39-8.37.78-13.63.78-11.49,0-16.55-5.06-16.55-17.13Z"
          />
          <rect
            className="cls-7"
            x="572.2"
